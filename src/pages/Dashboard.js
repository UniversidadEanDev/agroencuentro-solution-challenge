    ...
    <div class='h-screen flex overflow-hidden bg-gray-100'>
      ...
      <div class='lg:hidden'>
        <div class='fixed inset-0 flex z-40'>
          ...
          <div class='relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-yellow-700'>
            ...
            <div class='px-4 sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8'>
              <div class='py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200'>
                ...
                {/* <div class='mt-6 flex space-x-3 md:mt-0 md:ml-4'>
                  ...
                  <button type='button' class='inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500'>
                    Send money
                  </button>
                </div> */}
              </div>
